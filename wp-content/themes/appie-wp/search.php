 ...
 */
	...
	$blog_sidebar = appie_option('blog_sidebar',3);
	...
	<main id="site-content" class="content-area section-padding blog" role="main">
		<div class="container">
			<div class="blog-posts-list">
				<div class="row blog-masonry blog__grid <?php echo esc_attr(appie_option('blog_grid',0)?'appie__grid_blog':'') ?>">
					    ...
					    <div class="row"> 
							<?php if ( have_posts() ) : ?>
								    <div class="quomodo-page-header search-page-header col-md-12">
										<h2>
											<?php printf(esc_html__('Search Results for: %s', 'appie'), get_search_query()); ?>
										</h2>
									</div>
									...
									<?php endwhile; ?>
									<?php if( !appie_option( 'blog_grid',0 ) ): ?>
										<div class="col-md-12">
