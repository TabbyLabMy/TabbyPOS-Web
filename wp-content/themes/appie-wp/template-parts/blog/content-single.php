    <?php
        $show = appie_option('blog_single_banner_show',1);
    ?>
    <div class="single-post-area">
        <?php if ( has_post_thumbnail() && !post_password_required() && appie_option('single_post_thumnnail',1) ) : ?>
        ...
        <div class="blog-content">
                ...
                <?php
                    if ( is_search() ) {
                        ...
                        the_content( esc_html__( 'Continue reading &rarr;', 'appie' ) );
                        appie_link_pages();
                    }
                ?>
        </div>
