...
$alignment = esc_attr(appie_option("blog_post_nav_alignment"));
echo "<ul class='pagination mt-md-3 mb-5 qstm-pagination $alignment'>" . "\n";

// previous Post Link
if ( get_previous_posts_link() ){
    printf( '<li class="prev">%s</li>' . "\n", get_previous_posts_link( '<i class="fa fa-arrow-left"></i>'.esc_html__('Prev','appie') ) );
}
...
if ( get_next_posts_link() ){
    printf( '<li class="next">%s</li>' . "\n", get_next_posts_link( esc_html__('Next','appie').'<i class="fa fa-arrow-right"></i>' ) );
}
