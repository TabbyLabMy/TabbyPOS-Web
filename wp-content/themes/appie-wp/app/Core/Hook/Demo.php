...
class Demo
{
    ...
    function backups_demos($demos)
    {
        ...
        $demo_content_installer     = 'http://tf.quomodosoft.com/appie/demo-content';

        $demos_array             = array(
            'default'             => array(
                'title'             => esc_html__('All Demo', 'appie'),
                'screenshot'     => esc_url($demo_content_installer) . '/default/screenshot.png',
                'preview_link'     => esc_url('https://themeforest.net/user/appie/portfolio'),
            ),
